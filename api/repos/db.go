...
// creates a new instance of application file DB
...
// fetches a list of reminders by given ids
...
// writes a list of reminders to DB
...
// generates the next AUTOINCREMENT id for a reminder
func (d *DB) GenerateID() int {
	d.cfg.ID++
	return d.cfg.ID
}

// shuts down properly the file database by saving metadata to config file
...
// generates check sum for a reader
